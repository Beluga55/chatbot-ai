...
async function submitForm(event) {
  ...
  const response = await fetch(
    "https://chatbot-rreu.onrender.com/adminCreateUser",
    {
      method: "POST",
      headers: {
...
async function submitEditUserForm(event) {
  ...
  const response = await fetch(
    "https://chatbot-rreu.onrender.com/adminEditUser",
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
function triggerSubmitForm(e) {
  ...
  // REMOVE ALL THE ERROR TEXT WHEN CLICKED OUTSIDE OF ALL OF THE INPUTS
  if (
